...
class _CompetitionBlockState extends State<CompetitionBlock> {
  ...
  void initialize() {
    ...
    if (widget.competition.location != null) {
      ...
      String? lngStr = widget.competition.location?.longitude.toStringAsFixed(
        4,
      );
  ...
  Future<void> initializeAsync() async {
    if (widget.firstName.isEmpty || widget.lastName.isEmpty) {
      ...
      return UserService.fetchUser(widget.competition.organizerUid)
          .then((user) {
            if (!mounted) return;
            setState(() {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      StatCard(
                        title: "Visibility",
                        value: widget.competition.visibility.name,
                        icon: Icon(Icons.visibility, size: widget.iconSize),
                        titleFontSize: widget.titleFontSizeBlock,
                        valueFontSize: widget.valueFontSizeBlock,
                        innerPadding: widget.innerPaddingBlock,
                      ),
